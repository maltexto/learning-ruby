...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # plus equals operator (+=) when building up strings.  Why? performance
  end
  ...
  def test_any_ruby_expression_may_be_interpolated
    string = "The square root of 1 is #{Math.sqrt(1)}"
    assert_equal "The square root of 1 is 1.0", string
  end
