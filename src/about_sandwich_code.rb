...
class AboutSandwichCode < Neo::Koan
  ...
  def test_counting_lines
    assert_equal __, count_lines("assets/example_file.txt")
  end
  ...
  def test_finding_lines
    assert_equal __, find_line("assets/example_file.txt")
  end
  ...
  def test_counting_lines2
    assert_equal __, count_lines2("assets/example_file.txt")
  end
  ...
  def test_finding_lines2
    assert_equal __, find_line2("assets/example_file.txt")
  end
  ...
  def test_open_handles_the_file_sandwich_when_given_a_block
    assert_equal __, count_lines3("assets/example_file.txt")
  end
